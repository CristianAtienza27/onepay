...
public abstract class DetailControllerImpl<
   ...
   * (non-Javadoc)
   *
   * @see es.alten.example.web.DetailController#detail()
   */
  @GetMapping
  @Override
   ...
   *
   * @see
   * es.alten.example.web.DetailController#detailNew(org.springframework.ui.
   * ModelMap)
   */
   ...
   * (non-Javadoc)
   *
   * @see es.alten.example.web.DetailController#create(javax.servlet.http.
   * HttpServletRequest, es.alten.example.dto.BaseDTO,
   ...
   * (non-Javadoc)
   *
   * @see es.alten.example.web.DetailController#update(javax.servlet.http.
   * HttpServletRequest, java.io.Serializable, es.alten.example.dto.BaseDTO,
   * org.springframework.validation.BindingResult,
   * org.springframework.web.servlet.mvc.support.RedirectAttributes)
   */
  @Override
   ...
   * (non-Javadoc)
   *
   * @see es.alten.example.web.DetailController#detailEdit(javax.servlet.http.
   ...
   * (non-Javadoc)
   *
   * @see es.alten.example.web.DetailController#delete(javax.servlet.http.
