DROP TABLE IF EXISTS Multi_OnePay.users;

CREATE TABLE Multi_OnePay.users (
...
INSERT INTO Multi_OnePay.users (email,password,deleted,create_time,create_user_id,update_time,update_user_id)
